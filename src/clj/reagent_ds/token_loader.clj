...
(defn def-ns [filename]
  (str "(ns reagent-ds.tokens." filename ")\n\n"))
...
(defn create-tokens [[filename resource]]
  (let [props (read-tokens! resource)
    ...
    (write-tokens! (str "src/cljs/reagent_ds/tokens/" (str/replace filename #"-" "_") ".cljs") (concat (list nspace) tokens))))
